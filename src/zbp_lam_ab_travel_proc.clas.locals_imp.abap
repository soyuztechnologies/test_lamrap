CLASS lhc_Travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  ...
  types:  t_entity_create type table for create zlam_ab_travel_processor,
      t_entity_update TYPE table for update zlam_ab_travel_processor,
      t_entity_rep type table for REPORTED zlam_ab_travel_processor,
      t_entity_err type table for FAILED zlam_ab_travel_processor.
...
*         entities_c =
  ...
  METHOD augment_create.
    ...
    data: travel_create type table for create zlam_ab_travel.
     ...
     MODIFY augmenting entities of zlam_ab_travel
     entity travel
