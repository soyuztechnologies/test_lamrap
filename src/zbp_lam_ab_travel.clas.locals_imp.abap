CLASS lhc_Travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  ...
  types:  t_entity_create type table for create zlam_ab_travel,
          t_entity_update TYPE table for update zlam_ab_travel,
          t_entity_rep type table for REPORTED zlam_ab_travel,
          t_entity_err type table for FAILED zlam_ab_travel.
  ...
  METHOD get_instance_authorizations.
    ...
    loop at lt_travel into data(ls_travel).
        ...
        if ( ls_travel-OverallStatus = 'X' ).
            ...
            AUTHORITY-CHECK OBJECT 'ZL_AB_MGR'
                ID 'ACTVT' FIELD '03'.
